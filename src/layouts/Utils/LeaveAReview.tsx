...
export const LeaveAReview: React.FC<{}> = (props) => {
  ...
  return (
    <div className='dropdown' style={{ cursor: 'pointer' }}>
      <h5 id='dropdownMenuButton1' className='dropdown-toggle' data-bs-toggle='dropdown'>
        Leave a review?
      </h5>
      <ul id='submitReviewRating' className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
        <li><button onClick={() => starValue(0.0)} className='dropdown-item'>0 star</button></li>
        <li><button onClick={() => starValue(0.5)} className='dropdown-item'>.5 star</button></li>
        <li><button onClick={() => starValue(1.0)} className='dropdown-item'>1 star</button></li>
        <li><button onClick={() => starValue(1.5)} className='dropdown-item'>1.5 star</button></li>
        <li><button onClick={() => starValue(2.0)} className='dropdown-item'>2 star</button></li>
        <li><button onClick={() => starValue(2.5)} className='dropdown-item'>2.5 star</button></li>
        <li><button onClick={() => starValue(3.0)} className='dropdown-item'>3 star</button></li>
        <li><button onClick={() => starValue(3.5)} className='dropdown-item'>3.5 star</button></li>
        <li><button onClick={() => starValue(4.0)} className='dropdown-item'>4 star</button></li>
        <li><button onClick={() => starValue(4.5)} className='dropdown-item'>4.5 star</button></li>
        <li><button onClick={() => starValue(5.0)} className='dropdown-item'>5 star</button></li>
      </ul>
        ...
        <form method='POST' action='#'>
          ...
          <div className='mb-3'>
            ...
            <textarea className='form-control' id='submitReviewDescription' placeholder='Optional'
              rows={3} autoFocus={true} onChange={e => setReviewDescription(e.target.value)}>
            </textarea>
          </div>

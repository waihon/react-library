          ...
          <div className='col-4 col-md-4 container d-flex justify-content-center align-items-center'>
            <div className='ml-2'>
              ...
              {authState?.isAuthenticated ?
                <Link type='button' className='btn btn-primary main-color btn-lg text-white'
                  to='/search'>Explore top books</Link>
                :
                <Link type='button' className='btn btn-primary main-color btn-lg text-white' to='/login'>Sign up</Link>
              }
            </div>
          </div>
        </div>
